...
const EDotaUserMessages EDotaUserMessages_MAX = DOTA_UM_CharacterSpeakConcept;
...
const DOTA_CHAT_MESSAGE DOTA_CHAT_MESSAGE_MAX = CHAT_MESSAGE_INFORMATIONAL;
...
class CDOTAUserMsg_ParticleManager : public ::google::protobuf::Message {
 public:
  ...
  inline void set_allocated_update_particle_latency(::CDOTAUserMsg_ParticleManager_UpdateParticleLatency* update_particle_latency);
...
inline void CDOTAUserMsg_ParticleManager::set_allocated_update_particle_latency(::CDOTAUserMsg_ParticleManager_UpdateParticleLatency* update_particle_latency) {
  delete update_particle_latency_;
  update_particle_latency_ = update_particle_latency;
  if (update_particle_latency) {
    set_has_update_particle_latency();
  } else {
    clear_has_update_particle_latency();
  }
